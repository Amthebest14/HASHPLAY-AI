    ...
    <header className="w-full border-b-2 border-accent-teal bg-obsidian z-50 sticky top-0">
      <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center px-6 py-2 border border-red-500 text-red-500 bg-red-500/10 font-mono text-xs font-bold tracking-widest shadow-[0_0_10px_rgba(239,68,68,0.3)] min-w-[160px] justify-center clip-trapezoid-sm">
                [ NETWORK: TESTNET ]
            </div>
